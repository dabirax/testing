				...
				<div class="col-md-6 home-left-section">
					<div style="padding: 100px 0px; color: white;">
						...
						<div style="display: flex;">
							<a href="order.php" target="_blank" class="bttn_style_1" style="margin-right: 10px; display: flex;justify-content: center;align-items: center;" id="ordernow">
								Order Now
								<i class="fas fa-angle-right"></i>
							</a>
							<a href="#menus" class="bttn_style_2" style="display: flex;justify-content: center;align-items: center;" id="viewmenu">
								VIEW MENU
								<i class="fas fa-angle-right"></i>
							</a>
						</div>
                        ...
                        foreach($rows as $row) 
                        {
                            ...
                            else
                            {
                                ...
                                echo '<div class="menus_categories  tab_category_content" id="'.str_replace(' ', '', $row['category_name']).'">';
                                    ...
                                    if($stmt_menus->rowCount() == 0)
                                    {
                                        echo "<div id='nomenu' class = 'no_menus_div'>No Available Menus for this category!</div>";
                                    }
                ...
                echo "<div class = 'row'>";
	                ...
	                foreach($rows_image_gallery as $row_image_gallery)
	                {
	                	echo "<div  class = 'col-md-4 col-lg-3' style = 'padding: 15px;'>";
	                		...
	                		<div  style = "background-image: url('<?php echo $source; ?>') !important;background-repeat: no-repeat;background-position: 50% 50%;background-size: cover;background-clip: border-box;box-sizing: border-box;overflow: hidden;height: 230px;" id="galleryhover">
	                		</div>
...
s1.async=true;
s1.src='https://embed.tawk.to/63da9234c2f1ac1e2030d9ba/1go6sm7v5';
s1.charset='UTF-8';
